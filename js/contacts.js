...
async function createContact() {
  ...
  await postData(`Contacts/${userIndex}`, {
    name: name,
    mail: mail,
    phone: phone,
    color: contactColorIndex,
    id: `${userIndex}`,
  });
...
async function deleteContact() {
  ...
  let firebaseID = contacts.find(
    (x) => x.user && x.user.name === contactName
  ).id;
...
async function editContact() {
  ...
  await postData(`Contacts/${firebaseID}`, {
    name: name,
    mail: mail,
    phone: phone,
  });
